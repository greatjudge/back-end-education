...
urlpatterns = [
    ...
    path('tests/<int:test_id>/create/', tests_create, name='tests_create'),
    ...
    path('questions/<int:question_id>/create/', questions_create, name='questions_create'),
    ...
    path('choices/<int:choice_id>/create/', choices_create, name='choices_create'),
